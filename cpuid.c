...
#define F(n, str) [n] = #str
    ...
    F(0x61, ITLB;4kPage;full;48),
    F(0x63, DTLB;1GPage;4way;4),
    F(0x64, DTLB;4kPage;4way;512),
    F(0x66, L1d;8k;4way;64byte),
    F(0x67, L1d;16k;4way;64byte),
    F(0x68, L1d;32k;4way;64byte),
    F(0x6a, µTLB;4kPage;8way;64),
    F(0x6b, DTLB;4kPage;8way;256),
    F(0x6c, DTLB;2MPage+4MPage;8way;128),
    F(0x6d, DTLB;1GPage;full;16),
    ...
    F(0xc3, SharedL2TLB;4kPage+2MPage;6way;1536;1GPage;4way;16),
    F(0xc4, DTLB;2MPage+4MPage;4way;32),
